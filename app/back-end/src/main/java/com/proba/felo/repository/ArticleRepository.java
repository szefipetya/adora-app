...
public interface ArticleRepository extends JpaRepository<Article, String> {
    ...
    @Query(value="SELECT * FROM articles INNER JOIN tag_rel ON articles.id = tag_rel.article_id WHERE tag_rel.tag_id = :selected_tag AND articles.date_of_upload >= CURRENT_DATE - 7", nativeQuery = true)

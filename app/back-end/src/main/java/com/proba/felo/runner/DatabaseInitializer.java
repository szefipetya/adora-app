...
public class DatabaseInitializer implements CommandLineRunner {
        ...
        public void run(String... args) {
                ...
                // Set<Article> u2articles =
                // userService.getRelevantArticles(userService.getUserByUsername("user").get());
                // u2articles.isEmpty();
        }
        ...
        private List<Article> getArticles() {
                return Arrays.stream(ARTICLES_STR.split("\n"))
                                ...
                                .map(articleInfoArr -> new Article(1, "test", "test", "test.txt", new Date(), null,
                                                null))
